    ...
    <form id="edform" action="editform.php" method="post">
        ...
        <div id="dmid" class="container-fluid">
            ...
            <div class="row" style="background:#FFF;">
                <div class="col-sm-12">
                    <center>
                        <font style="color:black; font-family: Verdana; width:100%; font-size:20px;">
        ...
        <table class=" frmtbl" style="margin-top:20px;">
            <?php
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" id="cadr" name="cadr" value="<?php echo $row[12] ?>"><br>
                    <input type="text" id="cast" name="cast" value="<?php echo $row[13] ?>"
                        style="margin-top: 4px;"><br>
                    <input type="text" id="capin" name="capin" value="<?php echo $row[14] ?>"
                        style="margin-top: 4px;"><br>
                    <input type="text" id="camob" name="camob" value="<?php echo $row[15] ?>"
                        style="margin-top: 4px;"><br>
                </td>
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" id="padr" name="padr" value="<?php echo $row[16] ?>"><br>
                    <input type="text" id="past" name="past" value="<?php echo $row[17] ?>"
                        style="margin-top: 4px;"><br>
                    <input type="text" id="papin" name="papin" value="<?php echo $row[18] ?>"
                        style="margin-top: 4px;"><br>
                    <input type="text" id="pamob" name="pamob" value="<?php echo $row[19] ?>"
                        style="margin-top: 4px;"><br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" id="oarank" name="oarank" value="<?php echo $row[25] ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" id="oaroll" name="oaroll" value="<?php echo $row[26] ?>">
                </td>
                <td>
                ...
                <td colspan="3">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>
                                    <font style="font-family: Verdana;font-size: small">Exam</font>
                                    <br>
                                    <font style="font-family: Verdana; font-size: small">passed
                                    </font>
                                </th>
                                <th>
                                    <font style="font-family: Verdana;font-size: small">Name of
                                    </font> <br>
                                    <font style="font-family: Verdana;font-size: small">
                                        Board/University</font>
                                </th>
                                <th>
                                    <font style="font-family: Verdana;font-size: small">Year of
                                    </font> <br>
                                    <font style="font-family: Verdana;font-size: small"> Passing
                                    </font>
                                </th>
                                <th>
                                    <font style="font-family: Verdana;font-size: small">Total</font>
                                    <br>
                                ...
                                <th>
                                    <font style="font-family: Verdana;font-size: small">Mark</font>
                                    <br>
                                    <font style="font-family: Verdana;font-size: small">Obtained
                                    </font>
                                </th>
                                <th>
                                    <font style="font-family: Verdana;font-size: small">Division
                                    </font>
                                </th>
                                <th>
                                    <font style="font-family: Verdana;font-size: small">% of</font>
                                    <br>
                                    <font style="font-family: Verdana;font-size: small"> Marks
                                    </font>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" id="yop1" name="yop1" class="actab"
                                        value="<?php echo $row[34] ?>"></td>
                                <td><input type="text" id="tm1" name="tm1" class="actab" value="<?php echo $row[35] ?>">
                                </td>
                                <td><input type="text" id="mo1" name="mo1" class="actab" value="<?php echo $row[36] ?>">
                                </td>
                                <td><input type="text" id="divs1" name="divs1" class="actab"
                                        value="<?php echo $row[37] ?>"></td>
                                <td><input type="text" id="pom1" name="pom1" class="actab"
                                        value="<?php echo $row[38] ?>"></td>
                            </tr>
                            <tr>
                                <td><?php echo "12th/Diploma"; ?> </td>
                                <td><input type="text" id="nob2" name="nob2" value="<?php echo $row[39] ?>"></td>
                                <td><input type="text" id="yop2" name="yop2" class="actab"
                                        value="<?php echo $row[40] ?>"></td>
                                <td><input type="text" id="tm2" name="tm2" class="actab" value="<?php echo $row[41] ?>">
                                </td>
                                <td><input type="text" id="mo2" name="mo2" class="actab" value="<?php echo $row[42] ?>">
                                </td>
                                <td><input type="text" id="divs2" name="divs2" class="actab"
                                        value="<?php echo $row[43] ?>"></td>
                                <td><input type="text" id="pom2" name="pom2" class="actab"
                                        value="<?php echo $row[44] ?>"></td>
                            </tr>
            ...
            <tr>
                <td colspan="4">
                    <center> <input type="submit" id="frmupdate" name="frmupdate" value="Update">
                    </center>
                </td>
            </tr>
