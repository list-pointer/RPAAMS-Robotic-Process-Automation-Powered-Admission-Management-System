...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="index" action="index.php" method="post">
        ...
        <div class="container-fluid">
            ...
            <div id="divtop">
                <div id="dmain">
                    <center><img src="./images/login.jpg" width="100px" height="100px"
                            style="margin-top:100px;margin-left:60px;">
                        <br>
                        <input type="text" id="u_id" name="u_id" class="form-control"
                            style="width:300px; margin-left: 66px;margin-top:20px;"
                            placeholder="Enter Your User ID"><br>
                        <input type="password" id="u_ps" name="u_ps" class="form-control"
                            style="width:300px; margin-left: 66px;" placeholder="Enter Your Password"><br>
                        <input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary"
                            style="width:300px; margin-left: 66px;margin-bottom:10px"><br>
                        <a href="signup.php" style="margin-left: 50px;">New USer? Sign Up </a>
                    </center>
                </div>
            </div>
        </div>
