...
<body style="background-image:url('./images/inbg.jpg');">
    <form id="adform" action="admissionform.php" method="post">
        ...
        <table class="frmtbl">
            ...
            <tr>
                <td>
                    <font style="font-family: Verdana;"> Aadhar Card Number</font>
                </td>
                <td colspan="3"> <input type="text" id="uphn1" name="uphn1" required="true"
                        VT="PH"> </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3"> 
                    <input type="text" id="uphn2" name="uphn2" required="true" VT="PH">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" id="cadr" name="cadr" class="ad" required="true"><br>
                    <input type="text" id="cast" name="cast" class="ad" placeholder="State" style="margin-top: 4px;"
                        required="true"><br>
                    <input type="text" id="capin" name="capin" class="ad" placeholder="Pin" style="margin-top: 4px;"
                        required="true"><br>
                    <input type="text" id="camob" name="camob" class="ad" placeholder="Mobile" style="margin-top: 4px;"
                        required="true"><br>
                </td>
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" id="padr" name="padr" class="ad" required="true"><br>
                    <input type="text" id="past" name="past" class="ad" placeholder="State" style="margin-top: 4px;"
                        required="true"><br>
                    <input type="text" id="papin" name="papin" class="ad" placeholder="Pin" style="margin-top: 4px;"
                        required="true"><br>
                    <input type="text" id="pamob" name="pamob" class="ad" placeholder="Mobile" style="margin-top: 4px;"
                        required="true"><br>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4">
                    <center> <input type="submit" onclick="validate();" id="frmnext" name="frmnext" value="Next"
