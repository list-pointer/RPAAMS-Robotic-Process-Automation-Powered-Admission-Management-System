...
?>
    <form id="admin" action="admin.php" method="post">
        ...
        <div class="container-fluid" id="dmid" style="background-color: #FFF;">
            <div class=" row">
                <div class="col-sm-12">
                    <center>
                ...
                <div id="myapp" class="tab-pane fade in active">
                            ...
                            <div class="col-sm-12">
                                <center>
                                    <table class="table table-bordered" style="font-family: Verdana">
                                        ...
                                        <tr>
                                            <td style="width:3%;">
                                                <center><img src="./images/spit_logo.jpg" width="50%"
                   ...
                   ?>
                      ...
                      ?>
                                            ...
                                            <td colspan="3">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>
                                                                <font style="font-family: Verdana;font-size: small">Exam
                                                                </font> <br>
                                                                <font style="font-family: Verdana; font-size: small">
                                                                    passed</font>
                                                            </th>
                                                            <th>
                                                                <font style="font-family: Verdana;font-size: small">Name
                                                                    of</font> <br>
                                                                <font style="font-family: Verdana;font-size: small">
                                                                    Board/University</font>
                                                            </th>
                                                            <th>
                                                                <font style="font-family: Verdana;font-size: small">Year
                                                                    of</font> <br>
                                                                <font style="font-family: Verdana;font-size: small">
                                                                    Passing</font>
                                                            </th>
                                                            ...
                                                            <th>
                                                                <font style="font-family: Verdana;font-size: small">Mark
                                                                </font> <br>
                                                                <font style="font-family: Verdana;font-size: small">
                                                                    Obtained</font>
                                                            </th>
                                                            ...
                                                            <th>
                                                                <font style="font-family: Verdana;font-size: small">% of
                                                                </font><br>
                                                                <font style="font-family: Verdana;font-size: small">
                                                                    Marks</font>
                                                            </th>
                                        ...
                                        <tr>
                                            <td>
                                                <font style="font-family: Verdana;">Medium of Instruction till class
                                                    10th</font>
                                            </td>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            <font style="font-family: Verdana; font-size:15px;"> 2) Print Application
                                            </font>
                                            <p align="right" style="font-family: Verdana; font-size:15px;">
                                                <a href="admissionReport.php">Click Here</a>
                                            </p>
                                        </li>

                                        <li class="list-group-item">
                                            <font style="font-family: Verdana; font-size:15px;"> 3) Edit Application
                                            </font>
                                            <p align="right" style="font-family: Verdana; font-size:15px;">
