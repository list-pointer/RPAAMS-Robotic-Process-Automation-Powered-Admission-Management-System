                ...
                <div class="col-sm-12">
                    <center>
                        <table class="table table-bordered" style="font-family: Verdana">
                            ...
                            <tr>
                                <td style="width:3%;">
                                    <center><img src="./images/spit_logo.jpg" width="50%" style="margin-top:40px;">
                                    </center>
                                </td>
                                <td style="width:11%;">
                                    <center>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <font style="font-family: Verdana;font-size: small">Name of</font>
                                                    <br>
                                                    <font style="font-family: Verdana;font-size: small">Board/University
                                                    </font>
                                                </th>
                                                <th>
                                                    <font style="font-family: Verdana;font-size: small">Year of</font>
                                                    <br>
