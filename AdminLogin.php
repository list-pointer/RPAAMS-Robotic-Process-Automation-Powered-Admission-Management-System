        ...
        <div id="adivtop">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <center>
                            <input type="text" id="a_id" name="a_id" class="form-control" style="width:300px;"
                                placeholder="Admin ID"><br><br>
                            <input type="password" id="a_ps" name="a_ps" class="form-control" style="width:300px;"
                                placeholder="Password"><br><br>
                            <input type="submit" id="a_sub" name="a_sub" value="Admin Login"
                                class="toggle btn btn-primary" style="width:300px;"><br>
                        </center>
                    </div>
